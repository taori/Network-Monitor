...
namespace NetworkMonitor.Framework.Mvvm.Utility
{
	public class ScreenHelper
	{
		public static IEnumerable<Screen> GetXIntersects(System.Windows.Window window)
		{
			var screens = GetTaskbarRects();
			var rect = new Rectangle((int)window.Left, (int)window.Top, (int)window.Width, (int)window.Height);
